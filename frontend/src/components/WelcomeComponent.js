                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={6}>
                            <Typography paragraph={true} align={"justify"}>
                                ...
                                <p>A round starts with each player rolling their dice and concealing them from the other
                                    players. One of the
                                    players is chosen at random to start the first round.</p>
                                <p>The player who goes first must set an initial bid. The bid must consist of a face
                                ...
                                <p>Additionally, any dice that rolls a 1 are included since 1 are wild. If there are
                                    more than or exactly the number of dice
                                    in play as the quantity then the player who doubted the bid losses a die.</p>
                                <p>If there are less dice in play than the quantity of the previous bid then the player
                                    who made the
