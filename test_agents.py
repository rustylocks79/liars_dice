...
from liars_dice import LiarsDice, MediumAgent, HardAgent, HeuristicAgent
...
if __name__ == '__main__':
    ...
    print("-------\nTesting Phase")
    agents_stats = game.test(10_000, [PlayerAgent(), MediumAgent(strategy), HardAgent(strategy), HeuristicAgent()], False)
