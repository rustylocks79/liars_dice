...
class LiarsDiceTests (unittest.TestCase):
    def test_actions(self):
        game = LiarsDice(3, 5)
        self.assertEqual([('raise', 1, 2), ('raise', 1, 3), ('raise', 1, 4), ('raise', 1, 5), ('raise', 1, 6)], game.actions())
        game.bid_history = [("raise", 2, 2)]
        self.assertEqual([('doubt',), ('raise', 2, 3), ('raise', 2, 4), ('raise', 2, 5), ('raise', 2, 6), ('raise', 3, 2), ('raise', 3, 3), ('raise', 3, 4), ('raise', 3, 5), ('raise', 3, 6)], game.actions())
